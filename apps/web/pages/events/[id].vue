<template>
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <template v-else>
      <NuxtLink to="/events" class="text-sm text-gray-500 hover:text-primary-600 mb-4 inline-block">
        &larr; Kembali ke daftar event
      </NuxtLink>

      <div class="h-56 md:h-72 bg-gradient-to-br from-primary-500 to-primary-700 rounded-xl flex items-center justify-center mb-8">
        <span class="text-white text-6xl md:text-8xl font-bold">{{ event.title.charAt(0) }}</span>
      </div>
