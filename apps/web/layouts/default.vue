        ...
        <div class="flex justify-between h-16 items-center">
          ...
          <div class="flex items-center gap-2 md:gap-3">
            <template v-if="auth.isAuthenticated">
              ...
              <NuxtLink to="/my/tickets" class="btn-outline text-sm !py-1.5 hidden sm:inline-flex">
                Tiket Saya
              </NuxtLink>
              <NuxtLink v-if="auth.isAdmin" to="/tickets/scan" class="btn-outline text-sm !py-1.5 hidden sm:inline-flex">
                Scan
              </NuxtLink>
              <button
                @click="handleLogout"
                class="text-sm text-red-600 hover:text-red-700 font-medium transition-colors px-2 py-1.5 hidden sm:inline-flex items-center gap-1"
              >
        ...
        <div class="absolute right-0 top-0 bottom-0 w-72 max-w-[80vw] bg-white shadow-xl overflow-y-auto">
          ...
          <div class="p-4 space-y-1">
            ...
            <template v-if="auth.isAuthenticated">
              ...
              >
                <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5H9a2 2 0 00-2 2v10a2 2 0 002 2h6a2 2 0 002-2V7a2 2 0 00-2-2z" />
                </svg>
                Tiket Saya
              </NuxtLink>
